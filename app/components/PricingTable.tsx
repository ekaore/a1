...
export default function PricingTable() {
  ...
  const tariffs: Tariff[] = [
    ...
    { pattern: '810380', direction: 'Украина, стационарные', price: '21.36' },
    { pattern: '810380322', direction: 'Украина, Львов', price: '21.36' },
    { pattern: '81038039', direction: 'Украина, мобильные', price: '28.48' },
    { pattern: '81038044[245]', direction: 'Украина, Киев', price: '21.36' },
    { pattern: '81038048[27]', direction: 'Украина, Одесса', price: '21.36' },
    { pattern: '8103805637', direction: 'Украина, Днепропетровск', price: '21.36' },
    { pattern: '81038056[27][0-9]', direction: 'Украина, Днепропетровск', price: '21.36' },
    { pattern: '81038057[237]', direction: 'Украина, Харьков', price: '21.36' },
    { pattern: '810380622[0-9]', direction: 'Украина, Донецк', price: '21.36' },
    { pattern: '810380623[348]', direction: 'Украина, Донецк', price: '21.36' },
    { pattern: '810380692', direction: 'Украина, Севастополь', price: '21.36' },
    { pattern: '8103806[3678]', direction: 'Украина, мобильные', price: '28.48' },
    { pattern: '8103809[367]', direction: 'Украина, мобильные', price: '28.48' },
    { pattern: '810380[569]', direction: 'Украина, мобильные', price: '28.48' },
